...
function TrendingProduct() {
  const products = [
    { id: 1, img: "/image 1171.png" },
    { id: 2, img: "/image 1170.png" },
    { id: 3, img: "/image 31.png" },
    { id: 4, img: "/32.png" },
  ];

  const exclusiveProducts = [
    { id: 1, img: "/image 30.png" },
    { id: 2, img: "/image 28.png" },
    { id: 3, img: "/image 19.png" },
  ];
      ...
      <div className="w-full max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-pink-100 p-8 flex flex-col justify-between relative h-[200px]">
          ...
          <Image
            ...
            width={200}
            height={200}
            className="absolute bottom h-[150px] w-[150px] right-0 object-contain"
          />
        </div>
