...
function TopCategory() {
  const categories = [
    { id: 1, img: "/image 1166.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 2, img: "/image 1170.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 3, img: "/image 1171.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 4, img: "/white.png", name: "Mini LCW Chair", price: "$56.00" },
  ];
