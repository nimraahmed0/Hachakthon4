      ...
      <div className="w-full max-w-screen-xl mx-auto">
        ...
        <div className="flex justify-center space-x-8 mb-12">
          {["Wood Chair", "Plastic Chair", "Sofa Chair"].map((tag) => (
            <button
              key={tag}
              className="relative text-lg font-medium text-gray-700 hover:text-pink-600 hover:underline"
            >
              {tag}
        ...
        {/* Main Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mx-14">
