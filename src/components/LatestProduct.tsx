...
function LatestProducts() {
  const products = [
    { id: 1, img: "/image 23.png" },
    { id: 2, img: "/image 31.png", sale: true },
    { id: 3, img: "/image 1166.png" },
    { id: 4, img: "/white.png" },
    { id: 5, img: "/image 15.png" },
    { id: 6, img: "/cushion.png" },
  ];
      ...
      <div className="w-full max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 ">
        {products.map((product, index) => (
          <div key={product.id} className="relative group">
            {/* Product Image */}
            <div className="w-full bg-gray-300 flex justify-center items-center relative overflow-hidden
             h-[300px] transition-all duration-300 group-hover:bg-white ">
              {/* Sale Tag */}
              {product.sale && (
