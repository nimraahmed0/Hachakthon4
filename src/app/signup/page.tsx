...
function SignUp() {
  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row min-h-screen place-content-center py-11">
     

      {/* Right Section (Form) */}
      <div className="w-full sm:w-1/2 flex justify-center items-center  border
       border-gray-300 rounded-md bg-white p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full px-6 py-2 bg-pink-600 text-white font-semibold rounded-md hover:bg-pink-200"
            >
              Create an Account
            </button>
